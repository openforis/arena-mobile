...
You can delete your data at any time from within the Application. Surveys and collected records can be deleted from the Surveys list or the Records list, as applicable.

If you upload data to the Arena server and you use the default server, you can also delete that data by accessing the Arena server and deleting it there.
