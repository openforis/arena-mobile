...
Deseja obtê-las novamente do servidor?`,
  ...
  coordinate: {
    ...
    connectingToSource: "A ligar a {{label}}...",
    convert: "Converter",
    ...
    headingSource: "Fonte de direção",
    headingSourceMagnetometer: "Sensor",
    headingSourceLocation: "GPS",
    keepXAndY: "Manter X e Y",
    locationHeadingNotAvailable: "Direção por GPS não disponível!",
    magnetometerNotAvailable: "Magnetômetro não disponível!",
    navigateToTarget: "Navegar para o alvo",
    srs: "$t(common:srs)",
    targetLocation: "Localização de destino",
    useCurrentLocation: "Usar localização atual",
    usingInternalFallback: "A usar GPS interno ({{label}} indisponível)",
    usingSource: "A usar {{label}}",
    x: "X",
    y: "Y",
...
Pressione '$t(common:stop)' quando concluído.`,
  ...
  fileAttribute: {
    ...
    fileMissing: "Ficheiro não encontrado no armazenamento local",
