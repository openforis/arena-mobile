...
Möchten Sie sie erneut vom Server abrufen?`,
  ...
  coordinate: {
    ...
    usingInternalFallback: "Internes GPS wird verwendet ({{label}} nicht verfügbar)",
    usingSource: "Verwende {{label}}",
    x: "X",
    y: "Y",
...
Drücken Sie '$t(common:stop)', wenn Sie fertig sind.`,
  ...
  fileAttribute: {
    ...
    fileMissing: "Datei nicht im lokalen Speicher gefunden",
