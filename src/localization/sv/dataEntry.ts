...
Fortsätta?`,
  ...
  coordinate: {
    ...
    connectingToSource: "Ansluter till {{label}}...",
    convert: "Konvertera",
    currentLocation: "Aktuell plats",
    distance: "Avstånd (m)",
    externalGpsGenericLabel: "extern GPS-enhet",
    getLocation: "Hämta plats",
    heading: "Kurs (grader)",
    headingOffset: "Kursavvikelse",
    headingSource: "Källan för riktning",
    headingSourceMagnetometer: "Sensor",
    headingSourceLocation: "GPS",
    keepXAndY: "Behåll X och Y",
    locationHeadingNotAvailable: "GPS-riktning är inte tillgänglig!",
    magnetometerNotAvailable: "Magnetometer inte tillgänglig!",
    navigateToTarget: "Navigera till mål",
    srs: "$t(common:srs)",
    targetLocation: "Målplats",
    useCurrentLocation: "Använd aktuell plats",
    usingInternalFallback: "Använder intern GPS ({{label}} är inte tillgänglig)",
    usingSource: "Använder {{label}}",
    x: "X",
    y: "Y",
