...
export default {
  ...
  geo: {
    ...
    editPolygonInstructions: `Сначала нажмите на полигон, чтобы выбрать его.
  Нажмите и удерживайте вершину, затем перетащите её, чтобы переместить.
  Нажмите на среднюю точку, чтобы добавить новую вершину, затем перетащите её в нужное место.`,
