...
export default {
  ...
  geo: {
    ...
    selectPolygonInstructions: "برای انتخاب، روی یک چندضلعی ضربه بزنید",
    editPolygonInstructions: `برای جابه‌جایی یک رأس، آن را لمس طولانی کرده و بکشید.
  برای افزودن رأس جدید، روی یک نقطه میانی ضربه بزنید و سپس آن را به جای دلخواه بکشید.
  روی یک رأس ضربه بزنید و سپس برای حذف آن، X قرمز را بزنید.`,
