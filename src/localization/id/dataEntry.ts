...
Apakah Anda ingin mengambilnya lagi dari server?`,
  ...
  coordinate: {
    ...
    usingInternalFallback: "Menggunakan GPS internal ({{label}} tidak tersedia)",
    usingSource: "Menggunakan {{label}}",
    x: "X",
    y: "Y",
